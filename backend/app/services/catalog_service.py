...
def _rules(focus_entities: list[str]) -> str:
    ...
    return (
        ...
        "3. LEAN — CHỈ lấy TÊN mục ngắn gọn. TUYỆT ĐỐI KHÔNG kèm giá trị cụ thể "
        "(số tiền, %, số ngày, điều kiện chi tiết).\n"
        "4. KHÔNG lấy làm entity: tên cột của bảng (vd \"Khách hàng đăng ký/không đăng ký gói...\"), "
        "tiêu đề/chân trang, tên công ty/địa chỉ/hotline, số trang, ghi chú đánh dấu (*), "
        "hay cả câu văn dài.\n"
        "5. Bỏ qua facet không xuất hiện. Nếu không có gì để trích, trả về {\"tree\": []}.\n\n"
